...
-- 경산시 대표 안전거래 장소 (초기 시범용) - 실제 좌표 반영
...
-- 경찰서/파출소 (3곳)
('SAFE-P-001', '경산경찰서 민원실 앞', 'POLICE', '경상북도 경산시 중앙로 132', '1층 민원실 앞 광장', 35.828653, 128.742810, 1, '24시간', 1, '경산시경찰', 'gyeongsan', 'ACTIVE'),
('SAFE-P-002', '중앙파출소 앞 광장', 'POLICE', '경상북도 경산시 중앙시장길 12', '전통시장/상권 인접', 35.826241, 128.744015, 1, '24시간', 1, '경산시경찰', 'gyeongsan', 'ACTIVE'),
('SAFE-P-003', '하양파출소 앞', 'POLICE', '경상북도 경산시 하양읍 하양로 78', '읍면권 안전거래 거점', 35.894231, 128.773845, 1, '24시간', 1, '경산시경찰', 'gyeongsan', 'ACTIVE'),

-- 시청/행정복지센터 (2곳)
('SAFE-G-001', '경산시청 민원실 정문', 'GOV', '경상북도 경산시 남천1로 187', '행정장소 신뢰도 최고', 35.833910, 128.731960, 1, '평일 09:00-18:00', 1, '경산시청', 'gyeongsan', 'ACTIVE'),
('SAFE-G-002', '경산시 서부동 행정복지센터 앞', 'GOV', '경상북도 경산시 서부로 45', '동 단위 접근성', 35.820253, 128.731508, 1, '평일 09:00-18:00', 1, '경산시청', 'gyeongsan', 'ACTIVE'),

-- CCTV 다중 설치 공영공간 (3곳)
('SAFE-C-001', '중앙시장 공영주차장', 'CCTV_ZONE', '경상북도 경산시 중앙시장길 1', '시장 거래 유입량 많음, CCTV 밀집', 35.826752, 128.743392, 1, '주간 06:00-22:00', 1, '경산시', 'gyeongsan', 'ACTIVE'),
('SAFE-C-002', '하양역 공영주차장', 'CCTV_ZONE', '경상북도 경산시 하양읍 하양역길 22', '대중교통 접근', 35.890762, 128.769301, 1, '05:00-23:00', 1, '경산시', 'gyeongsan', 'ACTIVE'),
('SAFE-C-003', '경산교육문화회관 앞 CCTV존', 'CCTV_ZONE', '경상북도 경산시 중앙로 128', '시민광장형 안전구역', 35.827111, 128.742395, 1, '24시간', 1, '경산시', 'gyeongsan', 'ACTIVE');
